...
public class Proyecto {
	...
	public static void menu() {
	    ...
	    do {
	        ...
	        centroEducativo = scanner.nextLine();
	         if (centroEducativo.equalsIgnoreCase("ilerna")) {
	            ...
	            System.out.println("El centro educativo '" + centroEducativo + "' no esta disponible en este momento.");
	        }
	    } while (!centroValido);
	    ...
	    String rolUsuario = IdentificarUsuario(usuario, contraseña);
	...
	public static String IdentificarUsuario(String usuario, String contraseña) {
		Connection conec = conexionBBDD();
		try {
			Statement consulta = conec.createStatement();
			ResultSet select = consulta.executeQuery("SELECT usuario, contraseña, rol FROM usuario");

			while (select.next()) {
				String usuarioBD = select.getString("usuario");
				String contrasenaBD = select.getString("contraseña");

				if (usuario.equals(usuarioBD) && contraseña.equals(contrasenaBD)) {
		...
		return null; // Si no se encuentra el usuario o la contrasena no coincide, devuelve null
	}
	...
	public static void gestionAlumnos() {
		...
		while (true) {
			...
			// Implementa las acciones correspondientes a cada opcion de gestion de alumnos
			switch (opcion) {
			case 1:
				System.out.print("Ingrese el código del alumno a modificar: ");
				int cod_alumnos_modificar = scanner.nextInt();
				...
				// Llamar al método ModificarAlumno para modificar los datos del alumno
				ModificarAlumno(cod_alumnos_modificar, matricula_modificar, dni_modificar, nombre_alumno_modificar, apellido_modificar_alumno_modificar, apellido2_alumno_modificar, cod_postal_modificar,
						localidad_modificar, provincia_modificar, domicilio_modificar, numero_telefono_modificar, correo_electronico_modificar, fecha_nacimiento_modificar, observaciones_modificar);
				break;
			case 2:
	...
	public static void modificarPersonal() {
        ...
        try {
            ...
            // Obtener los nuevos valores del personal
	...
	public static void gestionMaterias() {
		...
		while (true) {
			...
			// Implementa las acciones correspondientes a cada opcion de gestion de materias
			switch (opcion) {
			case 1:
				modificarMateria();
				break;
			case 2:
				...
				// Llama al método AltaPersona con los datos ingresados
	...
	public static void gestionAulas() {
		...
		while (true) {
			...
			// Implementa las acciones correspondientes a cada opcion de gestion de aulas
			switch (opcion) {
			case 1:
				modificarAula();
				break;
			case 2:
				...
				// Llama al método AltaAula con los datos ingresados
	...
	public static void gestionNotas() {
		...
		while (true) {
			...
			System.out.println("Seleccione una opcion:");
			System.out.println("1. Modificar notas");
			System.out.println("2. Alta notas");
			...
			// Implementa las acciones correspondientes a cada opcion de gestion de notas
			switch (opcion) {
			case 1:
				// Accion para modificar notas
				break;
			case 2:
