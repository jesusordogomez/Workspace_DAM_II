...
public class sudoku_JesusGuijarro {
	...
	public static void jugarsudoku() {
		...
		sudoku=sudoku_JesusGuijarro.basesudoku(sudoku);
		sudoku=sudoku_JesusGuijarro.intercambiofilas(sudoku);
		sudoku=sudoku_JesusGuijarro.intercambiocolumnas(sudoku);
		sudoku=sudoku_JesusGuijarro.borrarnumeros(sudoku);
		sudoku_JesusGuijarro.imprimirsudoku(sudoku);
	}
}
