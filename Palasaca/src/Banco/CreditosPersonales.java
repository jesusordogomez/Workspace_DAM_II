package Banco;
public class CreditosPersonales extends ProductosBancarios {
	...
	public CreditosPersonales(int clave, String descripcion, double comision, String fechaInicio, String fechaFinal,
			Cliente cliente, double saldoSolicitado, int plazoDevolucion, double interesMensual, double interesAnual,
