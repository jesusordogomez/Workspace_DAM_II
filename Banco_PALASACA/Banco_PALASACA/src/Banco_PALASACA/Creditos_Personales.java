...
public class Creditos_Personales extends ProductosBancarios {
	
	private double saldoSolicitado;
    private int plazoDevolucion; // En meses
	...
	public Creditos_Personales(int clave, String descripcion, double comision, String fechaInicio, String fechaFinal,
